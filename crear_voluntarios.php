...
require 'conexion.php';
$sql = "SELECT * FROM quiz_nutricional ";
...
?>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    ...
                    <div class="card mb-4">
					<div class="card-header"><i></i> Crear Voluntario</div>
					<div class="card-body">
							...
							<form id="frm" method="POST" autocomplete="off"  >
                                ...
                                <div class="col-md-12">
										<div class="form-group">
											...
											<select id="responsable" class="form-control" name="area" onchange="obtener()">
											
													<option disabled hidden selected>SELECCIONAR AREA DE TRABAJO</option>
    ...
    <div class="form-group">
        ...
        <input id="price" class="form-control" type="text" name="name" required placeholder="Nombre">
    </div>
</div>
...
<div class="form-group">
        ...
        <input id="documento" class="form-control" type="number" name="phone" required  placeholder="Numero Telefonico">
    </div>
</div>
<div class="col-md-12">
<div class="form-group">
        <label for="number">Correo</label>
        <input id="email" class="form-control" type="email" name="email" required  placeholder="Correo Responsable" >
    </div>
</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											<button class="btn btn-primary" type="submit" name="btnregistrar" id="btnAccion">Registrar</button>
											<button class="btn btn-danger" type="button" onclick="limpiarFormulario()">Cancelar</button>
										</div>
									</div>
								</div>
							</form>
...
$phone=$_POST["phone"];
	...
	$queryregistrar = "INSERT INTO voluntarios (name,phone,email,area) values
                                         ('$name','$phone','$email','$area')";
    

     // Redirige a otro archivo PHP y pasa la variable $nombre en la URL
 

	if (mysqli_query($conn, $queryregistrar)) {
		echo "<script> alert('Voluntario creado ');window.location= 'administra.php' </script>";
